$(Document).ready(function() {
  $(form#quizeus).submit(function(event) {
    ...
    var result = parseInt(moja+mbili+tatu+nne+tano+sita+saba+nane+tisa+kumi+kumi1+kumi2+kumi3+kumi4+kumi5+kumi6+kumi7+kumi8+kumi9+ishirini);
    $("#ugot").text("You got: " + result + "%");
